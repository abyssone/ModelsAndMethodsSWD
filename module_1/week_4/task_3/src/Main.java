...
import NumberParsingException.*;

public class Main {
    public static void main(String[] args) throws NumberParsingException {
        ...
        try {
            ...
            throw new NumberParsingException("Ошибка парсинга строки в целое число");
        }
